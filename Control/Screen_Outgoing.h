        ...
        switch (activePage)
        {
          ...
          case WiiPage:
            switch (counter)
            {
              ...
              case 3:
                writeObject(USERLED, 2, cameraBeacon[LEFT_CAMERA]);
                break;
              case 4:
                writeObject(USERLED, 3, !cameraBeacon[LEFT_CAMERA]);
                break;
              case 5:
                writeObject(USERLED, 4, cameraBeacon[RIGHT_CAMERA]);
                break;
              case 6:
                writeObject(USERLED, 5, !cameraBeacon[RIGHT_CAMERA]);
                break;
                counter = 0;
                break;
              default:
          ...
          case ServoOverride:
            ...
            {
              case 1:
                writeObject(ANGULARMETER, 5, overrideAngleLeft);
                break;
              case 2:
                break;
              case 3:
                break;
              case 4:
                writeObject(ANGULARMETER, 6, overrideAngleRight);
                break;
              case 5:
                break;
              case 6:
