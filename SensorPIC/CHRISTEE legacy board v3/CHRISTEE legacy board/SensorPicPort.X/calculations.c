...
{
    unsigned int holder = EncoderCurrentTimeRight - EncoderPastTimeRight;
    float actualTime = (float) holder * 0.0000128;
    float actualSpeed = (4.18 / actualTime) * 100;
...
{
    unsigned int holder = EncoderCurrentTimeLeft - EncoderPastTimeLeft;
    float actualTime = (float) holder * 0.0000128;
    float actualSpeed = (4.18 / actualTime) * 100;
